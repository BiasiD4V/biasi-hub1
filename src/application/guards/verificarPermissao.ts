...
const PERMISSOES: Record<AcaoSistema, PapelUsuario[]> = {
  ...
  criar_composicao_versao: ['dono', 'admin', 'gestor', 'orcamentista', 'engenheiro'],
  publicar_composicao_versao: ['dono', 'admin', 'gestor'],
  criar_template_versao: ['dono', 'admin', 'gestor'],
  publicar_template_versao: ['dono', 'admin'],
